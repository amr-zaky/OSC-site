...
<div id="laravel-Workshop-banner" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{asset('/images/laravelDark.jpeg')}}" alt="Laravel" id="laravelLogo">
    </div>
    <div class="carousel-item">
      <img src="{{asset('/images/giphy.gif')}}" alt="yourName" id="giphy">
    </div>
    <div class="carousel-item">
      <img src="{{asset('/images/watchList.gif')}}" alt="watchList" id="wList">
    </div>
     <div class="carousel-item">
  ...
  <a class="carousel-control-next" href="#laravel-Workshop-banner" data-slide="next">
    <span class="carousel-control-next-icon"></span>
        ...
        <div  id="loveCode">
         <img src="{{asset('/images/beautifulCode.png')}}" alt="phpFramework" id="phpFramework">
        ...
        <div class="row">
        <div class="col-sm-4">
        <img src="{{asset('/images/laravel-wrapper.gif')}}" alt="phpFramework" id="phpFramework"></div>
        <div class="col-sm-8">
        ...
        <div class="row">
        <div class="col-sm-4">
         <img src="{{asset('/images/mvc.gif')}}" alt="phpFramework" id="mvc-img"></div>
        <div class="col-sm-8">
